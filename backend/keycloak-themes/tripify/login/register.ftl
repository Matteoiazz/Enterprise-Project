        ...
        <head>
            ...
            <style>
                ...
                *{ box-sizing:border-box; margin:0; padding:0; }
                ...
                /* --- Segmented toggle: Viaggiatore / Organizzatore --- */
                .tf-toggle{
                    display:flex;
                    background:var(--tf-bg);
                    border-radius:var(--tf-radius-sm);
                ...
                .tf-field-error-text{ color:var(--tf-error); font-size:12px; margin-top:5px; font-weight:600; }
        ...
        <div class="tf-shell">
            ...
            <div class="tf-form-panel">
                ...
                <form id="kc-register-form" action="${url.registrationAction}" method="post" onsubmit="document.getElementById('kc-register-submit').disabled=true; return true;">
                    ...
                    <!-- Hidden attribute actually sent to Keycloak / User Profile -->
                    ...
                    <div class="tf-grid">
                        <div class="tf-field">
                            ...
                            <#if messagesPerField.existsError('firstName')>
                                <div class="tf-field-error-text">${kcSanitize(messagesPerField.get('firstName'))?no_esc}</div>
                            </#if>
                        </div>
                        ...
                        <div class="tf-field">
                            ...
                            <#if messagesPerField.existsError('lastName')>
                                <div class="tf-field-error-text">${kcSanitize(messagesPerField.get('lastName'))?no_esc}</div>
                            </#if>
                        </div>
                        ...
                        <div class="tf-field full">
                            ...
                            <#if messagesPerField.existsError('email')>
                                <div class="tf-field-error-text">${kcSanitize(messagesPerField.get('email'))?no_esc}</div>
                            </#if>
                        </div>
                        ...
                        <div id="organizer-fields">
                            ...
                            <div class="tf-grid">
                                ...
                                <div class="tf-field">
                                    ...
                                    <div class="tf-input-wrap">
                                        <input type="text" id="user.attributes.pec" name="user.attributes.pec"
                            ...
                            <div class="tf-field">
                                ...
                                <div class="tf-input-wrap">
                                    <input type="password" id="password" name="password"
                                           class="<#if messagesPerField.existsError('password','password-confirm')>tf-input-error</#if>"
                                           placeholder="••••••••" autocomplete="new-password"/>
                                </div>
                                <#if messagesPerField.existsError('password')>
                                    <div class="tf-field-error-text">${kcSanitize(messagesPerField.get('password'))?no_esc}</div>
                                </#if>
                            </div>
                            <div class="tf-field">
                                ...
                                <div class="tf-input-wrap">
                                    <input type="password" id="password-confirm" name="password-confirm"
                                           class="<#if messagesPerField.existsError('password-confirm')>tf-input-error</#if>"
                                           placeholder="••••••••" autocomplete="new-password"/>
                                </div>
                                <#if messagesPerField.existsError('password-confirm')>
                                    <div class="tf-field-error-text">${kcSanitize(messagesPerField.get('password-confirm'))?no_esc}</div>
                                </#if>
                            </div>
                        </#if>
                    </div>
                    ...
                    <label class="tf-terms">
                        <input type="checkbox" required name="tfAcceptTerms"/>
                    ...
                    <button type="submit" id="kc-register-submit" class="tf-submit">Crea account</button>
                </form>
        ...
        <script>
            function tfToggleAccountType(){
                ...
                // required only when visible, so the "user" flow never gets blocked by hidden fields
            ...
            // init on load in case of a validation-error reload where organizer was previously selected
            document.addEventListener('DOMContentLoaded', tfToggleAccountType);
        </script>
        </body>
        </html>
