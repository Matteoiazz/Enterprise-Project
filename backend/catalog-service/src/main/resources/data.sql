...
-- ==========================================
-- 1. INSERIMENTO VOLO (ID 1) - Roma/NY
-- ==========================================
...
-- ==========================================
-- 2. INSERIMENTO HOTEL (ID 2) - New York
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 3. INSERIMENTO VOLO (ID 3) - Lamezia/Milano
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 4. INSERIMENTO HOTEL (ID 4) - Rende (Campus)
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 5. INSERIMENTO HOTEL (ID 5) - Fitness Resort
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 6. INSERIMENTO HOTEL (ID 6) - Tattoo Boutique
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 7. INSERIMENTO VOLO (ID 7) - Londra (Evento Medico)
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
...
-- ==========================================
-- 8. INSERIMENTO HOTEL (ID 8) - LAN Party Event
-- ==========================================
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active, category, rating)
