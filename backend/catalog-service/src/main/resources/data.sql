...
VALUES (1, 'Volo Roma - New York', 'Volo diretto operato da ITA Airways', 550.00, 'EUR', 101, true);
...
INSERT INTO catalog_items (id, title, description, price, currency, host_id, is_active)
VALUES (2, 'Hotel Hilton Times Square', 'Soggiorno di lusso nel cuore di Manhattan', 250.00, 'EUR', 202, true);
...
-- Sincronizzazione dei generatori di ID (per evitare errori nei prossimi inserimenti manuali)
